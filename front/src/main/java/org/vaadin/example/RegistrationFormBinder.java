...
public class RegistrationFormBinder {
    ...
    /**
     * Para deshabilitar la primera ejecución de la validación de contraseña
     */
    ...
    /**
     * Metodo para agregar el binding del data y la logica de la validacion al form
     */
     ...
     * <p>
     * 1) Password is at least 6 characters long
     * <p>
    ...
    private ValidationResult passwordValidator(String pass1, ValueContext ctx) {
        ...
        return ValidationResult.error("Las contraseñas no son iguales");
    }
    ...
    private void showSuccess(UserDetails userBean) {
        Notification notification =
                Notification.show("Registro exitoso, bienvenido " + userBean.getFirstName());
